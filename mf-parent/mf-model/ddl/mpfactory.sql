...
--
-- Table structure for table `agglo_connection`
--

DROP TABLE IF EXISTS `agglo_connection`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `agglo_connection` (
  `ID` bigint(20) NOT NULL,
  `AGGLOM_ID` bigint(20) DEFAULT NULL,
  `CITY_ID` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`ID`),
  UNIQUE KEY `ID` (`ID`),
  KEY `FK_AG_CO_AGGLOM_ID` (`AGGLOM_ID`),
  KEY `FK_AG_CO_CITY_ID` (`CITY_ID`),
  CONSTRAINT `CON_AG_CO_AGGLOM_ID` FOREIGN KEY (`AGGLOM_ID`) REFERENCES `agglo_name` (`ID`),
  CONSTRAINT `CON_AG_CO_CITY_ID` FOREIGN KEY (`CITY_ID`) REFERENCES `city` (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_polish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `agglo_connection`
--

LOCK TABLES `agglo_connection` WRITE;
/*!40000 ALTER TABLE `agglo_connection` DISABLE KEYS */;
INSERT INTO `agglo_connection` VALUES (1,1,161),(2,1,162),(3,1,688),(4,2,74),(5,2,93),(6,2,125),(7,2,165),(8,2,259),(9,2,445),(10,2,231),(11,2,539),(12,2,655),(13,2,629),(14,2,689),(15,2,763),(16,2,860);
/*!40000 ALTER TABLE `agglo_connection` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `agglo_name`
--

DROP TABLE IF EXISTS `agglo_name`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `agglo_name` (
  `ID` bigint(20) NOT NULL,
  `NAME` varchar(60) COLLATE utf8_polish_ci DEFAULT NULL,
  `STATE_ID` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`ID`),
  UNIQUE KEY `ID` (`ID`),
  KEY `FK_AG_NA_STATE` (`STATE_ID`),
  CONSTRAINT `CON_AG_NA_STATE` FOREIGN KEY (`STATE_ID`) REFERENCES `state` (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_polish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `agglo_name`
--

LOCK TABLES `agglo_name` WRITE;
/*!40000 ALTER TABLE `agglo_name` DISABLE KEYS */;
INSERT INTO `agglo_name` VALUES (1,'Trójmiasto',11),(2,'Okręg katowicki',12);
/*!40000 ALTER TABLE `agglo_name` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `company` (
  `ID` bigint(20) NOT NULL,
  `NAME` varchar(60) COLLATE utf8_polish_ci DEFAULT NULL,
  `FULL_NAME` varchar(160) COLLATE utf8_polish_ci DEFAULT NULL,
  `STREET_AND_NR` varchar(160) COLLATE utf8_polish_ci DEFAULT NULL,
  `CITY_ID` bigint(20) DEFAULT NULL,
  ...
  `WWW` varchar(250) COLLATE utf8_polish_ci DEFAULT NULL,
...
INSERT INTO `company` VALUES (10,'11','22',NULL,22,NULL,NULL,NULL,NULL,NULL,'2014-08-03 16:41:45'),(11,'11','22',NULL,22,NULL,NULL,NULL,NULL,NULL,'2014-08-03 16:42:29'),(12,'11','22',NULL,22,NULL,NULL,NULL,NULL,NULL,'2014-08-03 16:46:03'),(15,'11','11','11',11,11,'11','11','11','11','2014-08-03 17:51:22'),(16,'2222','22','222',22,222,'2222','2222','2222','2222','2014-08-03 17:52:03'),(17,'33','33','33',33,33,'33','33','33','33','2014-08-03 17:54:45'),(18,'44','44','44',44,44,'44','44','44','44','2014-08-03 17:55:20'),(19,'','','',NULL,NULL,'','','','','2014-08-20 20:11:57'),(20,'','','',NULL,NULL,'','','','','2014-09-05 19:57:52'),(21,'111','111','111',111,111,'111','111','111','111','2014-09-05 20:29:49');
/*!40000 ALTER TABLE `company` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `company_hist`
--

DROP TABLE IF EXISTS `company_hist`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Dumping data for table `company_hist`
--

LOCK TABLES `company_hist` WRITE;
/*!40000 ALTER TABLE `company_hist` DISABLE KEYS */;
/*!40000 ALTER TABLE `company_hist` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `counter` VALUES (1,'com.omn.mpfactory.model.State',1449),(2,'com.omn.mpfactory.model.Company',21),(3,'com.omn.mpfactory.model.CompanyHist',3),(4,'com.omn.mpfactory.model.User',9);
...
INSERT INTO `district` VALUES (1,'Bemowo',809),(2,'Białołęka',809),(3,'Bielany',809),(4,'Mokotów',809),(5,'Ochota',809),(6,'Praga-Południe',809),(7,'Praga-Północ',809),(8,'Rembertów',809),(9,'Śródmieście',809),(10,'Targówek',809),(11,'Ursus',809),(12,'Ursynów',809),(13,'Wawer',809),(14,'Wesoła',809),(15,'Wilanów',809),(16,'Włochy',809),(17,'Wola',809),(18,'Żoliborz',809),(19,'Bałuty',395),(20,'Górna',395),(21,'Polesie',395),(22,'Śródmieście',395),(23,'Widzew',395),(24,'Antoniuk',26),(25,'Bacieczki',26),(26,'Bema',26),(27,'Białostoczek',26),(28,'Bojary',26),(29,'Centrum',26),(30,'Dojlidy',26),(31,'Dojlidy Górne',26),(32,'Dziesięciny I',26),(33,'Dziesięciny II',26),(34,'Jaroszówka',26),(35,'Kawaleryjskie',26),(36,'Leśna Dolina',26),(37,'Mickiewicza',26),(38,'Młodych',26),(39,'Nowe Miasto',26),(40,'Piaski',26),(41,'Piasta I',26),(42,'Piasta II',26),(43,'Przydworcowe',26),(44,'Sienkiewicza',26),(45,'Skorupy',26),(46,'Słoneczny Stok',26),(47,'Starosielce',26),(48,'Wygoda',26),(49,'Wysoki Stoczek',26),(50,'Zawady',26),(51,'Zielone Wzgórza',26),(52,'Dolny Taras',72),(53,'Górny Taras',72),(54,'Północny Pas Rekreacyjny',72),(55,'Południowo-wschodnia dzielnica',72),(56,'Wschodnia dzielnica',72),(57,'Zachodnie osiedla',72),(58,'Błeszno',116),(59,'Częstochówka-Parkitka',116),(60,'Dźbów',116),(61,'Gnaszyn-Kawodrza',116),(62,'Grabówka',116),(63,'Kiedrzyn',116),(64,'Lisiniec',116),(65,'Mirów',116),(66,'Ostatni Grosz',116),(67,'Podjasnogórska',116),(68,'Północ',116),(69,'Raków',116),(70,'Stare Miasto',116),(71,'Stradom',116),(72,'Śródmieście',116),(73,'Trzech Wieszczów',116),(74,'Tysiąclecie',116),(75,'Wrzosowiak',116),(76,'Wyczerpy-Aniołów',116),(77,'Zawodzie-Dąbie',116),(132,'4 Marca',303),(133,'Akademickie',303),(134,'Bukowe',303),(135,'Chełmoniewo',303),(136,'Dzierżęcino',303),(137,'Jamno',303),(138,'Kędzierzyn',303),(139,'Kretomino',303),(140,'Lechitów',303),(141,'Lubiatowo',303),(142,'Łabusz',303),(143,'Na Skarpie',303),(144,'Przylesie',303),(145,'Raduszka.',303),(146,'Rokosowo',303),(147,'Sarzyno',303),(148,'Unii Europejskiej',303),(149,'Wenedów',303),(150,'Wilkowo',303),(151,'Zagórzyno',303),(152,'Żabowo',303),(153,'Północ',733),(154,'Prawobrzeże ',733),(155,'Śródmieście ',733),(156,'Zachód',733),(157,'Bieńczyce',315),(158,'Bieżanów-Prokocim',315),(159,'Bronowice',315),(160,'Dębniki',315),(161,'Czyżyny',315),(162,'Grzegórzki',315),(163,'Krowodrza',315),(164,'Łagiewniki-Borek Fałęcki',315),(165,'Mistrzejowice',315),(166,'Nowa Huta',315),(167,'Podgórze',315),(168,'Podgórze Duchackie',315),(169,'Prądnik Czerwony',315),(170,'Prądnik Biały',315),(171,'Stare Miasto',315),(172,'Swoszowice',315),(173,'Wzgórza Krzesławickie',315),(174,'Zwierzyniec',315),(175,'Abramowice',366),(176,'Bronowice',366),(177,'Bursaki',366),(178,'Czechów',366),(179,'Czuby',366),(180,'Dziesiąta',366),(181,'Hajdów',366),(182,'Kalinowszczyzna',366),(183,'Kośminek',366),(184,'Majdan Tatarski',366),(185,'Piaski',366),(186,'Ponikwoda',366),(187,'Rury (LSM)',366),(188,'Sławin i Sławinek',366),(189,'Śródmieście',366),(190,'Tatary',366),(191,'Wieniawa',366),(192,'Wrotków',366),(193,'Zemborzyce',366),(194,'Brzeziny',496),(195,'Dajtki',496),(196,'Generałów',496),(197,'Grunwaldzkie',496),(198,'Gutkowo',496),(199,'Jaroty',496),(200,'Kętrzyńskiego',496),(201,'Kormoran',496),(202,'Kortowo',496),(203,'Kościuszki',496),(204,'Likusy',496),(205,'Mazurskie',496),(206,'Nad Jeziorem Długim',496),(207,'Nagórki',496),(208,'Pieczewo',496),(209,'Podgrodzie',496),(210,'Podleśna',496),(211,'Pojezierze',496),(212,'Redykajny',496),(213,'Śródmieście',496),(214,'Wojska Polskiego',496),(215,'Zatorze',496),(216,'Zielona Górka',496),(217,'Bierkowice',503),(218,'Groszowice',503),(219,'Grotowice',503),(220,'Gosławice',503),(221,'Grudzice',503),(222,'Kolonia Gosławicka',503),(223,'Malina',503),(224,'Nowa Wieś Królewska',503),(225,'Półwieś',503),(226,'Szczepanowice',503),(227,'Śródmieście',503),(228,'Wójtowa Wieś',503),(229,'Wróblin',503),(230,'Zakrzów',503),(231,'Grunwald',572),(232,'Jeżyce',572),(233,'Nowe Miasto',572),(234,'Stare Miasto',572),(235,'Wilda',572),(236,'Borki',606),(237,'Brzustówka',606),(238,'Długojów',606),(239,'Długojów Górny',606),(240,'Dzierzków',606),(241,'Firlej',606),(242,'Glinice',606),(243,'Godów',606),(244,'Gołębiów',606),(245,'Gołębiów 1',606),(246,'Gołębiów 2',606),(247,'Halinów',606),(248,'Huta Józefowska',606),(249,'Idalin',606),(250,'Janiszpol',606),(251,'Jeżowa Wola',606),(252,'Józefów',606),(253,'Kaptur',606),(254,'Kierzków',606),(255,'Koniówka',606),(256,'Kończyce',606),(257,'Kozia Góra',606),(258,'Krychnowice',606),(259,'Krzewień',606),(260,'Malczew',606),(261,'Malenice',606),(262,'Miasto Kazimierzowskie',606),(263,'Michałów',606),(264,'Mleczna',606),(265,'Młodzianów',606),(266,'Młynek Janiszewski',606),(267,'Nowa Wola Gołębiowska',606),(268,'Nowiny Malczewskie',606),(269,'Obozisko',606),(270,'Osiedle Akademickie',606),(271,'Osiedle Nad Potokiem',606),(272,'Osiedle XV-lecia',606),(273,'Planty',606),(274,'Południe',606),(275,'Potkanów',606),(276,'Prędocinek',606),(277,'Pruszaków',606),(278,'Rajec Poduchowny',606),(279,'Rajec Szlachecki',606),(280,'Sadków',606),(281,'Stara Wola Gołębiowska',606),(282,'Stare Miasto',606),(283,'Śródmieście',606),(284,'Ustronie',606),(285,'Wacyn',606),(286,'Wielogóra',606),(287,'Wincentów',606),(288,'Wośniki',606),(289,'Wólka Klwatecka',606),(290,'Zamłynie',606),(291,'Żakowice',606),(292,'Baranówka',642),(293,'Biała',642),(294,'Budziwój',642),(295,'Drabinianka',642),(296,'Gen. Andersa',642),(297,'Gen. Dąbrowskiego',642),(298,'Gen. Grota-Roweckiego',642),(299,'Kmity (dawniej: os. Gwardzistów)',642),(300,'Kotuli',642),(301,'Krakowska – Południe',642),(302,'Króla Stanisława Augusta',642),(303,'Mieszka I',642),(304,'Miłocin',642),(305,'Nowe Miasto',642),(306,'Paderewskiego',642),(307,'Piastów',642),(308,'Pobitno',642),(309,'Przybyszówka',642),(310,'Pułaskiego',642),(311,'Słocina',642),(312,'Staroniwa',642),(313,'Śródmieście – Północ',642),(314,'Śródmieście – Południe',642),(315,'Staromieście',642),(316,'Tysiąclecia',642),(317,'Wilkowyja',642),(318,'Zalesie',642),(319,'Załęże',642),(320,'Zwięczyca',642),(321,'Barbarka',776),(322,'Bielany',776),(323,'Bielawy',776),(324,'Bydgoskie Przedmieście',776),(325,'Chełmińskie Przedmieście',776),(326,'Czerniewice',776),(327,'Glinki',776),(328,'Grębocin Nad Strugą',776),(329,'Jakubskie Przedmieście',776),(330,'Kaszczorek',776),(331,'Katarzynka',776),(332,'Koniuchy',776),(333,'Mokre',776),(334,'Na Skarpie',776),(335,'Piaski',776),(336,'Podgórz',776),(337,'Rubinkowo',776),(338,'Rudak',776),(339,'Rybaki',776),(340,'Stare Miasto',776),(341,'Starotoruńskie Przedmieście',776),(342,'Stawki',776),(343,'Winnica',776),(344,'Wrzosy',776),(345,'Fabryczna',849),(346,'Krzyki',849),(347,'Psie Pole',849),(348,'Stare Miasto',849),(349,'Śródmieście',849);
...
CREATE TABLE `user` (
  ...
  `password_hash` varchar(160) COLLATE utf8_polish_ci DEFAULT NULL,
...
INSERT INTO `user` VALUES (3,'asdfasd','asdfasdf',NULL,NULL,NULL),(4,'','asdfasdf',NULL,NULL,NULL),(5,'lk','lk',NULL,NULL,NULL),(6,'df','kjhkjhk',NULL,NULL,NULL),(7,'j','j',NULL,NULL,NULL),(8,'d','d',NULL,NULL,NULL),(9,'u','u',NULL,NULL,NULL);
...
-- Dump completed on 2014-09-20 15:44:30
