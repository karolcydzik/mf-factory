...
INSERT INTO `counter` VALUES (1,'com.omn.mpfactory.model.State',1049);
...
--
-- Dumping routines for database 'mpfactory'
--
...
-- Dump completed on 2014-07-28 20:04:30
...
DROP TABLE IF EXISTS `company`;
CREATE TABLE company_hist as SELECT * FROM company;