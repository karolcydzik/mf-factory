package com.omn.mpfactory.hibernate.state.service;
...
@ContextConfiguration(locations = { "classpath*:com/omn/mpfactory/hibernate/state/service/ApplicationContext.xml" })
